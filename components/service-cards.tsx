...
function AnimatedButton({ text, href }: { text: string; href: string }) {
  ...
  return (
    <Link
      href={href}
      className="w-full md:max-w-2xl px-6 md:px-8 py-4 md:py-5 bg-chart-5/10 text-chart-5 tracking-tight border border-black-50 font-medium text-[18px] md:text-xl rounded-lg hover:bg-[#ff3b00] hover:text-white transition-all duration-300 ease-out flex items-center justify-center gap-3 group"
    >
      <span className="relative overflow-hidden inline-flex">
        {/* Primary text - slides down on hover */}
        <span className="flex">
      ...
      <svg
        className="w-6 h-6 text-black group-hover:text-white group-hover:translate-x-1 transition-transform duration-300 ease-out"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
  ...
  return (
    <div>
      <div ref={containerRef} className="relative mt-16 md:mt-20 lg:mt-24 space-y-8 md:space-y-0">
        ...
        >
          <div className="p-8 md:p-8 bg-background shadow-lg shadow-black/50 backdrop-blur-sm border border-chart-5/50 rounded-2xl flex-1 min-h-80 md:min-h-96 flex flex-col justify-between md:-rotate-2 hover:rotate-0 transition-transform duration-500 ease-out">
            <div
        ...
        <div className="md:grid md:grid-cols-2 md:gap-8 md:relative md:ml-20 space-y-8 md:space-y-0">
          ...
          <div
            className="p-8 md:p-8 bg-background shadow-lg shadow-black/50 backdrop-blur-sm border border-chart-5/50 rounded-2xl flex flex-col justify-between min-h-80 md:min-h-72 md:rotate-1 hover:rotate-0 transition-transform duration-500 ease-out"
            style={{
          ...
          <div
            className="p-8 md:p-8 bg-background shadow-lg shadow-black/50 backdrop-blur-sm border border-chart-5/50 rounded-2xl flex flex-col justify-between min-h-80 md:min-h-72 md:-rotate-1 hover:rotate-0 transition-transform duration-500 ease-out md:mt-12"
            style={{
